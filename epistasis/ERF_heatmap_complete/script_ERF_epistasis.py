...
with open('new_paramgrid_epistasis.txt', 'rb') as f:
...
for q1 in along_qd:
    ...
    for ttr in along_ttr:
        ...
        control = simulation(init,b_array,a0,a1,q0,q0,m,tim,ttr)*1e-2
        with_treatment = simulation(init,b_array,a0,a1,q0,q1,m,tim,ttr)*1e-2        
...
output = '/home/labs/pilpel/gabril/COVID_merck/review/epistasis/ERF_heatmap_complete/'

with open(output + 'true_results_'+str(param)+'.txt', 'wb') as f:
