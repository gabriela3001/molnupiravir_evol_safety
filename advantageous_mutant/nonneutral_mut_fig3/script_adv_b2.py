...
with open('paramgrid_brateadv_Yvsu1.txt', 'rb') as f:
...
output = '/home/labs/pilpel/gabril/COVID_merck/final_runs/nonneutral_mut_fig3/'

with open(output+'results_infection_advb_'+str(param)+'.txt', 'wb') as f:
