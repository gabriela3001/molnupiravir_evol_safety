...
mrate = param_grid[param]['mrate']*10
...
output_dir = '/home/labs/pilpel/gabril/COVID_merck/plos_revision/plus_minus_strand/plus_minus_simulation_low_mrate/'

with open(output_dir + 'results_plus_minus_'+str(param) + '_' + str(niter)+ '.txt', 'wb') as f:
    pickle.dump(sim, f)